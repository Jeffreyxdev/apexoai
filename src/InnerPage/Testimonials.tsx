...
const testimonials = [
  ...
  },
  {
    ...
    testimonial:
      "After struggling for months to find the right fit, Apexoai connected me with a company that perfectly matched my skills and values. Couldn't be happier!",
  },
];

const Testimonial: React.FC = () => {
  return (
    <section className="py-20 bg-gradient-to-t from-[#040116] to-[#25002c] backdrop-blur-sm">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-white max-w-2xl mx-auto">
            Hear from professionals who found their perfect career match through ApexoAI
          </p>
        </div>
          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="border border-white/20 rounded-xl hover:shadow-xl transition-shadow backdrop-blur-lg">
              <CardContent className="p-8">
                ...
                <p className="text-white mb-6">{testimonial.testimonial}</p>
                <div>
